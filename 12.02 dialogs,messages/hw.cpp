...
BOOL CALLBACK DlgProc(HWND hWnd, UINT mes, WPARAM wp, LPARAM lp)
{
	...
	case WM_LBUTTONUP:
	{
		...
		// Проверяем, что размеры статика не меньше 10х10
